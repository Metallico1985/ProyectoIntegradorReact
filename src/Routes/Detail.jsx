            ...
            <div className="mainDetail" style={{ backgroundColor: item.color[0] }}>
                ...
                <header className="headerDetail">
                    <div className="nameDetContainer">
                        <Link to={"/"} > <img src="../Icons/arrow-left.png" alt="" /></Link>
                        <h3>{item.name}</h3>
                    </div>
                    <div className="nameDetContainer">
                        <h4>{"#" + item.id}</h4>
                ...
                <div className="statsCard">
                    <div className="typeContainer">
                        <div className="type">
                            {item.type.length > 1 ?
                                <div className="type">
                                    <div className="typeBtn" style={{ backgroundColor: item.color[0] }}>{item.type[0]}</div>
                                    <div className="typeBtn" style={{ backgroundColor: item.color[1] }}>{item.type[1]}</div>
                                </div>
                                :
                                <div className="type">
                                    <div className="typeBtn" style={{ backgroundColor: item.color[0] }}>{item.type[0]}</div>
                    ...
                    <div className="aboutTitle"><h3 style={{ color: item.color[0] }}>About</h3></div>
                    <div className="about">
